...
client = "C:\\Users\\Pimentas\\Documents\\GitHub\Projeto_ADis\Projeto 4\client"
            ...
            if comandoPedido == 'CREATE':
                if comando[1] == 'UTILIZADOR':
                    if len(comando) == 4:
                        ...
                        r = requests.post('https://localhost:5000/utilizadores', json = dados, verify= certs + '\\root.pem', cert=(certs + '\\cli.crt', client + '\\cli.key'))
                    ...
                    if len(comando) == 3:
                        r = requests.post('https://localhost:5000/artistas', json = {'id_spotify': comando[2]}, verify= certs + '\\root.pem', cert=(certs + '\\cli.crt', client + '\\cli.key'))
                        print (r.status_code)
                        print (r.content.decode())
                        print (r.headers)
                        print ('***')
                    ...
                    if len(comando) == 3:
                        r = requests.post('https://localhost:5000/albuns', json = {'id_spotify': comando[2]}, verify= certs + '\\root.pem', cert=(certs + '\\cli.crt', client + '\\cli.key'))
                        print (r.status_code)
                        print (r.content.decode())
                        print (r.headers)
                        print ('***')
                    ...
                    if len(comando) == 4:
                        if is_int(comando[1]) == True and is_int(comando[2]) == True:
                            if comando[3] in ['M', 'm', 'S', 'B', 'MB']:
                                r = requests.post('https://localhost:5000/utilizadores/' + comando[1] + '/avaliacoes/' + comando[2], json = {'avaliacao': comando[3]}, verify= certs + '\\root.pem', cert=(certs + '\\cli.crt', client + '\\cli.key'))
                                print (r.status_code)
                                print (r.content.decode())
                                print (r.headers)
                                print ('***')
                ...
                if comando[1] == 'UTILIZADOR':
                    if len(comando) == 3:
                        if is_int(comando[2]) == True:
                            if verificaComando:
                                r = requests.get('https://localhost:5000/utilizadores/' + comando[2], verify= certs + '\root.pem', cert=(certs + '\\cli.crt', client + '\\cli.key'))
                            else:
                                r = requests.delete('https://localhost:5000/utilizadores/' + comando[2], verify= certs + '\root.pem', cert=(certs + '\\cli.crt', client + '\\cli.key'))
                    ...
                    if len(comando) == 3:
                        if is_int(comando[2]) == True:
                            if verificaComando:
                                r = requests.get('https://localhost:5000/artistas/' + comando[2], verify= certs + '\root.pem', cert=(certs + '\\cli.crt', client + '\\cli.key'))
                            else:
                                r = requests.delete('https://localhost:5000/artistas/' + comando[2], verify= certs + '\root.pem', cert=(certs + '\\cli.crt', client + '\\cli.key'))
                    ...
                    if len(comando) == 3:
                        if is_int(comando[2]) == True:
                            if verificaComando:
                                r = requests.get('https://localhost:5000/albuns/' + comando[2], verify= certs + '\root.pem', cert=(certs + '\\cli.crt', client + '\\cli.key'))
                            else:
                                r = requests.delete('https://localhost:5000/albuns/' + comando[2], verify= certs + '\root.pem', cert=(certs + '\\cli.crt', client + '\\cli.key'))
                    ...
                    if len(comando) == 3:
                        if comando[2] == 'UTILIZADORES':
                            verificador = True
                            if verificaComando:
                                r = requests.get('https://localhost:5000/utilizadores', verify = certs + '\\root.pem', cert=(certs + '\\cli.crt', client + '\\cli.key'))
                            else:
                                r = requests.delete('https://localhost:5000/utilizadores', verify= certs + '\\root.pem', cert=(certs + '\\cli.crt', client + '\\cli.key'))
                        elif comando[2] == 'ARTISTAS':
                            verificador = True
                            if verificaComando:
                                r = requests.get('https://localhost:5000/artistas', verify= certs + '\\root.pem', cert=(certs + '\\cli.crt', client + '\\cli.key'))
                            else:
                                r = requests.delete('https://localhost:5000/artistas', verify= certs + '\\root.pem', cert=(certs + '\\cli.crt', client + '\\cli.key'))
                        elif comando[2] == 'ALBUNS':
                            verificador = True
                            if verificaComando:
                                r = requests.get('https://localhost:5000/albuns', verify= certs + '\\root.pem', cert=(certs + '\\cli.crt', client + '\\cli.key'))
                            else:
                                r = requests.delete('https://localhost:5000/albuns', verify= certs + '\\root.pem', cert=(certs + '\\cli.crt', client + '\\cli.key'))
                    ...
                    if len(comando) == 4:
                        if is_int(comando[3]) == True:
                            if verificaComando:
                                r = requests.get('https://localhost:5000/artistas/' + comando[3] + '/albuns', verify= certs + '\\root.pem', cert=(certs + '\\cli.crt', client + '\\cli.key'))
                            else:
                                r = requests.delete('https://localhost:5000/artistas/' + comando[3] + '/albuns', verify= certs + '\\root.pem', cert=(certs + '\\cli.crt', client + '\\cli.key'))
                            print (r.status_code)
                            print (r.content.decode())
                            print (r.headers)
                            print ('***')
                    ...
                    if len(comando) == 4:
                        if is_int(comando[3]) == True:
                            if verificaComando:
                                r = requests.get('https://localhost:5000/utilizadores/' + comando[3] + '/avaliacoes', verify= certs + '\\root.pem', cert=(certs + '\\cli.crt', client + '\\cli.key'))
                            else:
                                r = requests.delete('https://localhost:5000/utilizadores/' + comando[3] + '/avaliacoes', verify= certs + '\\root.pem', cert=(certs + '\\cli.crt', client + '\\cli.key'))
                            print (r.status_code)
                            print (r.content.decode())
                            print (r.headers)
                            print ('***')
                    ...
                    if len(comando) == 3:
                        ...
                        if comando[3] in ['M', 'm', 'S', 'B', 'MB']:
                            if verificaComando:
                                r = requests.get('https://localhost:5000/albuns/avaliacoes', json = {'avaliacao': comando[3]}, verify= certs + '\\root.pem', cert=(certs + '\\cli.crt', client + '\\cli.key'))
                            else:
                                r = requests.delete('https://localhost:5000/albuns/avaliacoes', json = {'avaliacao': comando[3]}, verify= certs + '\\root.pem', cert=(certs + '\\cli.crt', client + '\\cli.key'))
                            print (r.status_code)
                            print (r.content.decode())
                            print (r.headers)
                            print ('***')
                ...
                if comando[1] == 'ALBUM':
                    if len(comando) == 5:
                        if is_int(comando[2]) == True and is_int(comando[4]) == True:
                            if comando[3] in ['M', 'm', 'S', 'B', 'MB']:
                                ...
                                r = requests.put('https://localhost:5000/utilizadores/' + comando[4] + '/avaliacoes/' + comando[2], json = {'avaliacao': comando[3]}, verify= certs + '\\root.pem', cert=(certs + '\\cli.crt', client + '\\cli.key'))
                                print (r.status_code)
                                print (r.content.decode())
                                print (r.headers)
                                print ('***')
                    ...
                    if len(comando) == 4:
                        if is_int(comando[2]) == True:
                            ...
                            r = requests.put('https://localhost:5000/utilizadores/' + comando[2], json = dados, verify= certs + '\\root.pem', cert=(certs + '\\cli.crt', client + '\\cli.key'))
                            print (r.status_code)
                            print (r.content.decode())
                            print (r.headers)
                            print ('***')
